...
This does NOT start live trading - there is no code in this repository
that can submit a live order (src/execution/paper_node.py only builds a
TradingMode.PAPER/testnet node; no live Bybit exec-client wiring exists).
This script exists so the automated half of "is it safe to go live" - as
distinct from the operational/manual half, see
docs/LIVE_READINESS_CHECKLIST.md - can be checked and recorded before that
live path is ever built or used.
