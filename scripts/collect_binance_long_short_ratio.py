"""CLI: run the live Binance global long/short account-ratio poller
...
Usage:
    python scripts/collect_binance_long_short_ratio.py --symbol BTCUSDT
"""
...
from src.data.binance_derivatives_collector import BinanceLongShortRatioCollector
...
def collect(
    ...
    log.info(
        "starting binance long/short ratio collector",
        symbol=symbol,
        period=period,
        data_dir=str(resolved_data_dir),
        poll_interval_secs=poll_interval_secs,
    )
    collector = BinanceLongShortRatioCollector(
        symbol,
        resolved_data_dir,
        period=period,
        poll_interval_secs=poll_interval_secs,
