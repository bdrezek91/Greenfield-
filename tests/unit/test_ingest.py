"""fetch_klines must page correctly, dedupe, and stay within [start, end]."""
...
class FakeBybitClient:
    """Simulates Bybit's kline endpoint: newest-first pages, capped at `limit`."""
    ...
    def get_kline_page(
        self, *, category: str, symbol: str, interval: str, start_ms: int, end_ms: int, limit: int
    ) -> list[list[str]]:
